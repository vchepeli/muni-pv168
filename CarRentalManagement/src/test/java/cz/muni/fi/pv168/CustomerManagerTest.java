...
public class CustomerManagerTest {
    ...
    public void testAddCustomer() {
        ...
        customer = customer.withUuid(null);
        try {
            manager.addCustomer(customer);
            fail();
        } catch (IllegalArgumentException ex) {
    ...
    public void testRemoveCustomer() {
        ...
        String ID1 = customer1.uuid();
        String ID2 = customer2.uuid();
        String ID3 = customer3.uuid();
        ...
        customer1 = customer1.withUuid(ID1);
    ...
    public void testUpdateCustomerInfo() {
        ...
        customer = customer.withUuid("non-existent-id");
    ...
    private static Comparator<Customer> CustomerByIDComparator = new Comparator<Customer>() {
        ...
        public int compare(Customer customer1, Customer customer2) {
            return customer1.uuid().compareTo(customer2.uuid());
        }
    };
}
