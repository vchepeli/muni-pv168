...
public class RentlManagerTest {
    ...
    private void prepareTestData() {
        ...
        carWithoutID = newCar("Green", "8B3 9763", "Audi", 400.0).withUuid(null);
        carNotInDB = newCar("Blue", "3B6 8463", "Peugeot", 0.0).withUuid("non-existent-id");

        customerWithoutID = newCustomer("Martin", "Pulec", "Brno", "5-11-24", "AK 897589").withUuid(null);
        customerNotInDB = newCustomer("Lukas", "Rucka", "Brno", "5-21-06", "AK 256354").withUuid("non-existent-id").withActive(true);
    }
    ...
    public void getAllCustomerCars() {
        ...
        car1 = carManager.findCarByID(car1.uuid());
        car2 = carManager.findCarByID(car2.uuid());
    ...
    public void getCarFromCustomer() {
        ...
        car3 = carManager.findCarByID(car3.uuid());
        customer2 = customerManager.findCustomerByID(customer2.uuid());
