...
public class Customer {
    ...
    public Customer withUuid(String uuid) {
        return new Customer(uuid, firstName, lastName, address, phoneNumber, driversLicense, active);
    }

    public Customer withActive(Boolean status) {
        return new Customer(uuid, firstName, lastName, address, phoneNumber, driversLicense, status);
    }

    public Customer withAddress(String newAddress) {
        return new Customer(uuid, firstName, lastName, newAddress, phoneNumber, driversLicense, active);
    }

    public Customer withFirstName(String newFirstName) {
        return new Customer(uuid, newFirstName, lastName, address, phoneNumber, driversLicense, active);
    }

    public Customer withLastName(String newLastName) {
        return new Customer(uuid, firstName, newLastName, address, phoneNumber, driversLicense, active);
    }

    public Customer withPhoneNumber(String newPhoneNumber) {
        return new Customer(uuid, firstName, lastName, address, newPhoneNumber, driversLicense, active);
    }

    public Customer withDriversLicense(String newDriversLicense) {
        return new Customer(uuid, firstName, lastName, address, phoneNumber, newDriversLicense, active);
    }
}
